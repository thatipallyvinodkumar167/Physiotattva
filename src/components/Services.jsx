...
const servicesList = [
    {
        ...
        desc: 'Relieve pain and restore function for back, neck, and joint conditions with personalized therapy.',
        color: '#006D77'
    },
    {
        title: 'Sports Rehabilitation',
        icon: <SportsKabaddiIcon />,
        desc: 'Targeted recovery plans for athletes to regain strength and return to peak performance.',
        color: '#83C5BE'
    },
    {
        title: 'Post-Surgery Rehab',
        icon: <HealingIcon />,
        desc: 'Specialized care following orthopedic procedures to ensure optimal healing and mobility.',
        color: '#006D77'
    },
    {
        title: 'Neurological Physio',
        icon: <AccessibilityNewIcon />,
        desc: 'Advanced physical therapy for stroke, Parkinson’s, and multiple sclerosis recovery.',
        color: '#83C5BE'
    },
    {
        title: 'Geriatric Care',
        icon: <ElderlyIcon />,
        desc: 'Enhancing the quality of life for seniors through balance training and pain management.',
        color: '#006D77'
    },
    {
        title: 'Pediatric Physio',
        icon: <BabyChangingStationIcon />,
        desc: 'Compassionate care focused on developmental milestones and childhood conditions.',
        color: '#83C5BE'
    }
];
